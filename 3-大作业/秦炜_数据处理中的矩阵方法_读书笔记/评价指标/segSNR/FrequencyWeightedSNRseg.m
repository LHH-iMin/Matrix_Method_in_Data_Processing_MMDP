function fwseg_dist= FrequencyWeightedSNRseg(cleanFile, enhancedFile);

% ----------------------------------------------------------------------
%      Frequency weighted SNRseg Objective Speech Quality Measure
%
%   This function implements the frequency-weighted SNRseg measure [14-2]
%   using a different weighting function, the clean spectrum.
%
%   Usage:  fwSNRseg=FrequencyWeightedSNRseg.m(cleanFile.wav, enhancedFile.wav)
%           
...
%
%  Example call:  fwSNRseg =FrequencyWeightedSNRseg('sp04.wav','enhanced.wav')
%
%  
%  References:
%   [1]  Tribolet, J., Noll, P., McDermott, B., and Crochiere, R. E.
%   (1978).
...
if nargin~=2
    fprintf('USAGE: fwSNRseg=FrequencyWeightedSNRseg.m(cleanFile.wav, enhancedFile.wav)\n');
    fprintf('For more help, type: help FrequencyWeightedSNRseg.m\n\n');
    return;
end
