function [enhanced_speech] = logmmse_SPU(noisyfile,enhancedfile,option)
...
%
%
%  Example call:  [enhanced_speech] = logmmse_SPU('sp_noisy.wav','sp_enhanced.wav',1);
%
%  References:
...
[noisy_speech, Srate] = audioread(noisyfile);	
...
% wavwrite(enhanced_speech,Srate,16,enhancedfile);
