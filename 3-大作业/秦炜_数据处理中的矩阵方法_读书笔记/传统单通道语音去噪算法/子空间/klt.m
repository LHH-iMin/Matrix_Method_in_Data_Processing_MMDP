 function [enhanced_speech, fs, nbits] = klt(noisyfile, enhancedfile)
%
...
%
%  Example call:  klt('sp01_noisy.wav','out_klt.wav');
%
%  References:
...
%===========================================
[noisy_speech, fs] = audioread(noisyfile);
aInfo = audioinfo(noisyfile);
...
audiowrite(enhancedfile, enhanced_speech, fs, 'BitsPerSample', nbits);
end
