function [enhanced_speech] = mband(noisyfile, enhancedfile, Nband, Freq_spacing)

%  Implements the multi-band spectral subtraction algorithm [1].
% 
%  Usage:  [enhanced_speech] = mband(noisyfile, enhancedfile, Nband, Freq_spacing)
%           
...
%                        'linear', 'log' and 'mel'
%
%  Example call:  enhanced_speech = mband('sp_noisy.wav','sp_enhanced.wav',6,'linear');  
%
%  References:
